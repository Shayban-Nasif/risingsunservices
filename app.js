    ...
    <nav className="bg-white border-b sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <button onClick={() => navigate("home")} className="focus:outline-none">
          <img src="./assets/logos/RS-Logo-ver-new.png" alt="Rising Sun Services" className="h-8 w-auto object-contain" />
        </button>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-5 gap-10 mb-10">
          <div className="md:col-span-2">
            <img src="./assets/logos/RS-Logo-new.png" alt="Rising Sun Services" className="h-12 w-auto object-contain mb-4" />
